...
def _set_envs_and_config(server_args: ServerArgs):
    ...
    if threading.current_thread() is threading.main_thread():
        ...
        # This process will clean up the whole process tree
        # Note: This handler is active during the launch phase, and may be replaced by
        # the running_phase_sigterm_handler in the tokenizer manager after the grpc server is launched.
