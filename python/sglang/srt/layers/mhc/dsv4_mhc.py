"""Tilelang MHC pre/post kernels ported from deepseek_v4.

Provides the in-tree fused mhc_pre / mhc_post implementations used as the
default backend for ``sglang.srt.layers.mhc.functional``.
"""
