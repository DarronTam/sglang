...
from sglang.srt.utils.common import crash_on_warnings, get_bool_env_var, is_cuda, is_npu, is_zeus
...
_BUILT_IN_SAMPLING_BACKENDS = {"flashinfer", "pytorch", "ascend", "zeus"}
_is_zeus = is_zeus()
